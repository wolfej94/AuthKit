...
class Configuration {
    ...
    static let auth = AuthKit(bundle: Bundle.main.bundleIdentifier!, prompt: NSLocalizedString("ContentView.RefreshPrompt.Text", comment: ""), method: .sanctum, baseURL: url)
}
